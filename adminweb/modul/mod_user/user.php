...
if ($_SESSION[level] == 'Super'){
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<table id="tablekonten" class="table table-striped table-bordered table-responsive" style="">
					...
					<tbody>
						<?php 
						$tampil = mysqli_query($conn, "SELECT * FROM tuser ORDER BY userId ASC");
						$no=1;
	...
	case "edituser":
		$edit=mysqli_query($conn, "SELECT * FROM tuser WHERE userId='$_GET[id]'");
