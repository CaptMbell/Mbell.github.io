...
<head>
    ...
    <link rel="icon" href="images/logo_smaga.png">
...
<body background="">
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #1E90FF" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color: white">E-SURVEY</a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="#login" data-toggle="modal"><button class="btn btn-success btn-sm"><span class="glyphicon glyphicon-log-in"></span> Login</button></a></li>
                </ul>
    ...
    <div class="container">
        ...
        <div>
          <div style="background-color:#FFFFFF">
            <div class="col-lg-12">
                <img class="img-responsive" src="./images/logo sma.jpg" alt="" style="height:360px;width:1280px">
                <hr>
            </div>
              <div class="col-lg-12">
                  <p align="center" style="background-color:#1E90FF; color:white;" > <font size="5">SURVEY KEPUASAN PENGUNJUNG SMA N 3 PURWOKERTO</font></p>  
              </div>
              <div class="row">
                      ...
                      <form method='POST' action='aksi_kuosioner.php' onSubmit=\"return validasisurvey(this)\" >
                          ...
                          <table class="table" > 
                                  ...
                                  <td>
                                      <div class="form-horizontal"  style="margin-top:20px;background-color:#fff;padding-top:20px;padding-bottom:20px;">
                                          ...
                                          <div class="form-group">
                                             <label for="nama_pelanggan" class="control-label col-sm-2">Nama Pengunjung</label>
                                             <div class="col-sm-3">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <label for="produk" class="control-label col-sm-2">Status</label>
                                             <div class="col-sm-3">
                                                 <div class="input-group">
                                                     <div class="input-group-addon">
                              ...
                              <tr>
                                  ...
                                  <font face="Arial" size="1" color="white"><b>Mohon kesediaan Anda untuk memberikan 
                                  penilaian dan masukan pelayanan SMA N 3 Porwokerto, dimana hal ini sangat bermanfaat 
                                  untuk meningkatkan kualitas layanan kami.<br>
                                  </b><i>Silahkan diisi dengan mengklik option yang ada 
                              ...
                              <tr>
                                  <td colspan="9">
                                      <table class="table table-striped table-bordered">
                                          <thead>
                                              <th width='3%' bgcolor="#086ed4"  ><b><font face='Tahoma' size='2' style="color: white">No</font></b></th>
                                              <th colspan='2' bgcolor="#086ed4" ><p align='center'><b><font face='Tahoma' size='2' style="color: white">DESKRIPSI</font></b></th>
                                              <th colspan="5" bgcolor="#086ed4" ><p align='center'><font face='Tahoma' size='2' style="color: white">KUALITAS</font></th>
                                          </thead>
                                          <tbody>
                                              <?php
                                              include "koneksi.php";
                                              error_reporting(0);
                                              $no = 1;
                                              $sql = mysqli_query($conn,"SELECT * FROM tgroup");
                                              while($data = mysqli_fetch_array($sql)){
                                                  ...
                                                  echo "<tr valign='top'>
                                                          ...
                                                          <td height='25' width='8%' bgcolor='#1E90FF'><p align='center'><font face='Tahoma' size='1' color='white'>A<br>(Sangat Baik)</font></td>
                                                          <td height='25' width='8%' bgcolor='#1E90FF'><p align='center'><font face='Tahoma' size='1' color='white'>B<br>(Baik)</font></td>
                                                          <td height='25' width='8%' bgcolor='#1E90FF'><p align='center'><font face='Tahoma' size='1' color='white'>C<br>(Cukup)</font></td>
                                                          <td height='25' width='8%' bgcolor='#1E90FF'><p align='center'><font face='Tahoma' size='1' color='white'>D<br>(Buruk)</font></td>
                                                          <td height='25' width='8%' bgcolor='#1E90FF'><p align='center'><font face='Tahoma' size='1' color='white'>E<br>(Sangat Buruk)</font></td>
                                                      </tr>";
                                                      
                                                  $hasil = mysqli_query($conn, "SELECT * FROM tdescription, tgroup WHERE tdescription.groupId = '$id' AND tdescription.groupId = tgroup.groupId ORDER BY tgroup.groupId");
                                                  $i = 1;
                              ...
                              <tr>
                                  <td colspan="8"> <center><button type="submit" class="btn btn-success btn-lg">Submit</button></center> </td>
                              </tr>
                              <tr>
                              </tr>
                          </table>
    ...
    <nav class="navbar navbar-inverse navbar-absolut-bottom" role="navigation">
        <div class="container">
            ...
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <center><font color="white" size="1" ></font></center>
            </div>
            <!-- /.navbar-collapse -->
        </div>
        <!-- /.container -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <center>Copyright &copy; SMA N 3 PURWOKERTO<br> All rights reserved.</center>
